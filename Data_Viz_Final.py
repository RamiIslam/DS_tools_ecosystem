...
def update_output_container(selected_statistics, selected_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        recession_data = data[data['Year']==selected_year]
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile Sales',
            title="Avg sales by vehicle type"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
    ...
    # Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
                    ...
                    values=list(exp_rec.values),
                 names=list(exp_rec.index),
                 title="Expenditure Share by Vehicle"
                )
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
    ...
    # Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby(['Automobile_Sales','unemployment_rate'])['Automobile_Sales'].sum().reset_index()
